-- ===========================================
-- CrisisPM Platform - Database Schema
-- ===========================================
-- This SQL creates all required tables and RLS policies
...
-- ===========================================
-- Stores the generated crisis scenarios (44,928 unique combinations)
...
-- ===========================================
-- Stores user responses to crisis scenarios with AI assessments
...
-- ===========================================
-- Insert a sample crisis scenario for testing
...
-- Check tables exist
SELECT tablename FROM pg_tables WHERE schemaname = 'public' AND tablename IN ('profiles', 'crisis_scenarios', 'user_responses');

-- Check RLS is enabled
SELECT tablename, rowsecurity FROM pg_tables WHERE schemaname = 'public' AND tablename IN ('profiles', 'crisis_scenarios', 'user_responses');

-- Check sample data
SELECT id, category, title FROM public.crisis_scenarios LIMIT 1;

-- ===========================================
-- SCHEMA CREATION COMPLETE
-- ===========================================
-- Your CrisisPM database is now ready!
-- 
-- Next steps:
-- 1. Test user signup/login
-- 2. Verify profile creation trigger works
-- 3. Test crisis scenario fetching
-- 4. Build crisis generation engine